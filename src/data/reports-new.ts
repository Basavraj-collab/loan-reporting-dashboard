...
export const reports: Report[] = [
  // Business Dashboard - Business Health
  {
    ...
    metrics: [
      ...
      { label: 'Disbursement', value: '$24.2M', change: '+9%', trend: 'up', clickable: true, linkTo: 'popup:' },
      { label: 'Repayment rate', value: '94.2%', change: '+1.2%', trend: 'up' },
      { label: 'Collection', value: '$23.4M', change: '+8%', trend: 'up' },
      { label: 'Amount to be collected', value: '$28.5M', change: '+2.1%', trend: 'up' },
    ...
    rawData: {
      headers: ['Dimension', 'Dimension value', 'Disbursement', 'Principal collected'],
      rows: [
        ['Product variant', 'Flexi Loan', '$2.1M', '$1.8M'],
        ['Product variant', 'Personal Loan', '$1.8M', '$1.5M'],
        ['Product variant', 'Education Loan', '$0.3M', '$0.25M'],
        ['Age', '20–30', '$1.2M', '$1.0M'],
        ['Age', '30–40', '$4.1M', '$3.5M'],
        ['Age', '40–50', '$2.8M', '$2.4M'],
        ['Age', '50+', '$1.2M', '$1.0M'],
        ['Region', 'North', '$5.2M', '$4.5M'],
        ['Region', 'South', '$4.1M', '$3.6M'],
        ['Region', 'East', '$3.2M', '$2.8M'],
        ['Region', 'West', '$1.8M', '$1.5M'],
        ['Occupation', 'Salaried', '$6.0M', '$5.2M'],
        ['Occupation', 'Self Employed', '$2.5M', '$2.1M'],
        ['Occupation', 'Business', '$2.2M', '$1.9M'],
        ['Occupation', 'Student', '$0.9M', '$0.7M'],
      ],
    },
  },
  {
